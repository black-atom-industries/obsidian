# Black Atom x Obsidian

## Usefull links

- [Build a theme - Developer Documentation](https://docs.obsidian.md/Themes/App+themes/Build+a+theme)
- [CSS variables - Developer Documentation](https://docs.obsidian.md/Reference/CSS+variables/CSS+variables)
